...
Usage:
    ...
    prompt_text = skin.prompt(project_name="video.mp4", modified=True)
    skin.success("Video processed")
    skin.error("File not found")
    skin.warning("No input file")
    skin.info("Processing video...")
    skin.status("Input", "video.mp4")
...
_ACCENT_COLORS = {
    ...
    "topaz_video": "\033[38;5;198m",   # magenta/pink for Topaz
}
...
class ReplSkin:
    ...
    def print_banner(self):
        ...
        # Title:  ◆  cli-anything · Topaz Video
...
_ANSI_256_TO_HEX = {
    ...
    "\033[38;5;198m": "#ff0087",  # topaz magenta/pink
